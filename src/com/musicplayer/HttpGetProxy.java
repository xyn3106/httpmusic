...
public class HttpGetProxy {
	...
	public HttpGetProxy(int localport) {
		...
		try {
			...
			Log.e(TAG, " localServer = new ServerSocket fail : UnknownHostException ");
			e.printStackTrace();
		} catch (IOException e) {
			Log.e(TAG, " localServer = new ServerSocket fail : IOException ");
			e.printStackTrace();
		}
	}
	...
	private OnFinishListener finishListener = new OnFinishListener() {
		...
		public void onFinishListener() {
			...
			try {
				...
				Log.e(TAG, " release fail : IOException ");
				e.printStackTrace();
			}
		}
	};
